# KnowledgeCatalyst Backend

This is the backend component of KnowledgeCatalyst, built using the FastAPI framework to create a fast and modern API with Python.
...
## Contact
For questions or support, please open an issue in the GitHub repository or contact guglielmo.piacentini@dxc.com
